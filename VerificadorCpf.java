...
public class VerificadorCpf {
	...
	public static void main(String[] args) {
		...
		entrada = JOptionPane.showInputDialog("Digite o numero do cpf, somente os n�meros");
		ncpf = entrada;
		...
		dv1=0;
				...
				//verificar se o primeiro dv � verdadeiro
				temp2 = ncpf.substring(9,10);
				
				if(temp2.equals(ndv1))
				{
					//JOptionPane.showMessageDialog(null, "O primeiro dv � verdadeiro");
					...
					temp4 = temp2;
					JOptionPane.showMessageDialog(null, "o dv2 �: "+temp4);
					
					
					if(temp2.equals(ndv2))
					{
						JOptionPane.showMessageDialog(null, "O CPF � correto");
					}
					else
					{
						JOptionPane.showMessageDialog(null, "O cpf � incorreto");
					}
